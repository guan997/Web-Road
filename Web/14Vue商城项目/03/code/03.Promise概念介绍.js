...
// 初衷： 给路径，返回读取到的内容 （调用时执行）
function getFileByPath(fpath) {
    var promise = new Promise(function (resolve, reject) { //异步瞬间1执行return
...
// .then() 方法，【预先】 为 这个 Promise 异步操作，指定 成功（resolve） 和 失败（reject） 回调函数；

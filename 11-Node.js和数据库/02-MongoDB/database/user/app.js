...
// 		2.实现用户修改功能
// 			1.指定表单的提交地址以及请求方式 提交表单既有get又有post
    ...
    if(method == 'GET'){
        ...
        if(pathname == '/add'){
            ...
            req.on('end',async () => {
                ...
                // name=1245&password=124&age=33&email=1837536149%40qq.com&hobbies=%E7%AF%AE%E7%90%83
